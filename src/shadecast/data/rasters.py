...
WORLDCOVER = ("https://esa-worldcover.s3.amazonaws.com/v200/2021/map/"
...
def _mosaic(urls: list[str], aoi: AOI, resampling: Resampling,
    ...
    for u in urls:
        try:
            ...
            # Ocean-only tiles are simply absent from these buckets.
            continue
    if hit == 0:
